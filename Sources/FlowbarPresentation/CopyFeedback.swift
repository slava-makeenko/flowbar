...
/// и расходиться этому поведению незачем. Регламент §6. Тем же способом экран лимитов
/// подтверждает перечитывание: это такое же мгновенное действие без видимого результата.
///
